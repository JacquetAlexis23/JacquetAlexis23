...
### 📊 [TechCore - Dashboard Interactivo de Ventas](./PROYECTO_3_HENRY)
**Business Intelligence con Power BI** | Análisis de 30,000 facturas en 11 años
- **Tech Stack**: Power BI, DAX, Power Query, Modelo Relacional
- **Alcance**: 4 ciudades · 6 sucursales · 44 productos · 12 marcas
- **Features**: Modelo estrella, seguridad RLS por rol, KPIs interactivos

### 🏦 [FinanceGuard Bank - Predicción de Churn](./PROYECTO_4_HENRY)
**Machine Learning para retención de clientes** | Tasa de churn del 20% anual
- **Tech Stack**: Scikit-learn, XGBoost, LightGBM, CatBoost, K-Means
- **Dataset**: 10,000 clientes bancarios europeos · 14 variables predictoras
- **ROI**: Potencial recuperación de $10M+ en pérdidas anuales por abandono

### ⚙️ [MLOps Pipeline - Predicción de Pagos Bancarios](https://github.com/JacquetAlexis23/ProyectoM5_JacquetAlexis)
**MLOps end-to-end productivo** | API REST + Dashboard + Docker + CI/CD
- **Tech Stack**: FastAPI, Streamlit, Docker Compose, SonarCloud, pytest
- **Modelos**: 11 algoritmos evaluados · 35 features engineered
- **Calidad**: 27 tests automatizados · Quality Gate SonarCloud aprobado

### 🛒 [Nexus RecSys - Sistema de Recomendación E-Commerce](https://github.com/JacquetAlexis23/Nexus-RecSys)
**🎓 Proyecto Final Henry** | Pipeline end-to-end NB01–NB15 sobre RetailRocket
- **Tech Stack**: PyTorch, Transformers (SASRec), FastAPI, Streamlit, Optuna
- **Dataset**: 2.75M eventos de comportamiento de usuarios (RetailRocket)
- **Champion**: Mega-Ensemble NDCG@10 = 0.04310 (+50.8% vs baseline RP3+TD)
...
- **Clasificación**: Sentiment Analysis, Image Classification, Predictive Analytics, Churn Prediction
...
- **Deep Learning**: CNN, RNN, Transformers, Computer Vision, Mult-VAE, SASRec
- **RecSys**: Collaborative Filtering, Ensemble Methods, EASE^R, LightGCN
- **MLOps**: Pipelines productivos, FastAPI, Docker, CI/CD, SonarCloud
